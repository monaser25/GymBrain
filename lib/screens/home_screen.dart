...
class _DashboardView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final weightString = lastInBody != null ? "${lastInBody.weight} kg" : "--";
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        // Switch to Stats (Index 2)
                        // Since we are inside a nested widget, we can't easily set state of parent.
                        // But we can navigate or let the bottom bar handle it.
                        // For now, let's just push ProgressScreen since it's also a standalone page capability
                        // Or better, find the parent state? No, let's just push.
                        Navigator.push(
                          context,
                          MaterialPageRoute(
              ...
              // Removed duplication of "My Routines" list here, since it's now in the "Workout" tab.
            ],
          ),
        ),
      ),
